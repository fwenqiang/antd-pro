...
const requestOptions = [
  {
    url: 'http://localhost:8080/jfinal-admin/fileUpload/list',
    data: {
      cityCode: '01010101',
    },
    desc: 'aaaa',
  ...
  {
    url: 'http://localhost:8080/jfinal_demo_for_maven/blog/test',
    data: {
      cityCode: '01010101',
    },
    desc: 'aaaa',
...
const props = {
  name: 'file.docx',
  action: 'http://localhost:8080/jfinal-admin/fileUpload/upload',
  headers: {
    // authorization: 'authorization-text',
    // 'Content-Type':'multipart/form-data; boundary=----WebKitFormBoundary6wbfNsMssDgmKenI',
  },
  data:{'d':'this is data'},
  onChange(info) {
